...
### Tutorial
- copiare lo script translate_module.py nella cartella  ./odoo-folder/src19/odoo[versione]/
- Eseguire il comando:

## bash
'''
 python3 translate_module.py -d lab19 -m academy_system -p ../lab19 --db_port 5423 --db_user odoo --db_password myodoo 
'''
